...
namespace Owin
{
    ...
    /// </summary>
    public static class SSOAccountAuthenticationExtensions
    {
        /// <summary>
        ...
        public static IAppBuilder UseSSOAccountAuthentication(this IAppBuilder app, SSOAccountAuthenticationOptions options)
        {
            if (app == null)
            {
            ...
            app.Use(typeof(SSOAccountAuthenticationMiddleware), app, options);
            return app;
        }
        ...
        /// <returns></returns>
        public static IAppBuilder UseSSOAccountAuthentication(
            this IAppBuilder app,
            string clientId,
            string clientSecret)
        {
            return UseSSOAccountAuthentication(
                app,
                new SSOAccountAuthenticationOptions
                {
                    ClientId = clientId,
