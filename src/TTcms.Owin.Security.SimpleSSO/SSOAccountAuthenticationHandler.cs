...
{
    internal class SSOAccountAuthenticationHandler : AuthenticationHandler<SSOAccountAuthenticationOptions>
    {

        private readonly ILogger _logger;
        private readonly HttpClient _httpClient;

        public SSOAccountAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new SSOAccountAuthenticatedContext(Context, accountInformation, accessToken,
                    refreshToken, expire);
                context.Identity = new ClaimsIdentity(
                    new[]
                    {
                        ...
                        new Claim("urn:ttcmssso:id", context.Id, "http://www.w3.org/2001/XMLSchema#string", Options.AuthenticationType),
                        new Claim("urn:ttcmssso:name", context.Name, "http://www.w3.org/2001/XMLSchema#string", Options.AuthenticationType)
                    },
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new SSOAccountApplyRedirectContext(
                    Context, Options,
        ...
        public async Task<bool> InvokeReturnPathAsync()
        {
            ...
            var context = new SSOReturnEndpointContext(Context, model);
