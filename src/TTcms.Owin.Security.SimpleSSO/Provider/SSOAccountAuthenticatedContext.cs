...
namespace TTcms.Owin.Security.SSO
{
    ...
    /// </summary>
    public class SSOAccountAuthenticatedContext : BaseContext
    {
        /// <summary>
        /// Initializes a <see cref="SSOAccountAuthenticatedContext"/>
        /// </summary>
        ...
        public SSOAccountAuthenticatedContext(IOwinContext context, JObject user, string accessToken, 
            ...
            : base(context)
        {
            ...
            Id = userId.ToString();
            Name = PropertyValueIfExists("UserName", userAsDictionary);

            if (userAsDictionary.ContainsKey("email"))
            {
                JToken emailsNode = user["email"];
