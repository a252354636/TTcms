...
namespace TTcms.Owin.Security.SSO
{
    ...
    /// </summary>
    public class SSOAccountApplyRedirectContext : BaseContext<SSOAccountAuthenticationOptions>
    {
        /// <summary>
        ...
        public SSOAccountApplyRedirectContext(IOwinContext context, SSOAccountAuthenticationOptions options,
