...
using TTcms.SSO.Server.SignalRHubs.Admin;
using Microsoft.AspNet.SignalR;
using TTcms.SSO.Server.SignalRHubs;

namespace TTcms.SSO.Server.Code.OAuth
{
    public class SSOOAuthProvider : OAuthAuthorizationServerProvider
    {
